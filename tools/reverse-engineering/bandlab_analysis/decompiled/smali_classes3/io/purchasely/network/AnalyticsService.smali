...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "retrofit",
        "LNN/W;",
        "getRetrofit$core_5_2_1_release",
        "setRetrofit$core_5_2_1_release",
        "(LNN/W;)V",
        "core-5.2.1_release"
    }
    k = 0x1
...
.method public constructor <init>(Lio/purchasely/network/NetworkInterceptor;Lio/purchasely/network/AnalyticsInterceptor;)V
    ...
    invoke-direct {p0}, Lio/purchasely/network/AnalyticsService;->buildRetrofit()LNN/W;

    move-result-object p1

    iput-object p1, p0, Lio/purchasely/network/AnalyticsService;->retrofit:LNN/W;
...
.method private final buildRetrofit()LNN/W;
    ...
    invoke-direct {p0}, Lio/purchasely/network/AnalyticsService;->provideOkHttpClient()LmN/E;
    ...
    invoke-virtual {v1}, Lio/purchasely/ext/PLYAPIEnvironment;->getTrackingUrl$core_5_2_1_release()Ljava/lang/String;
...
.method private final provideOkHttpClient()LmN/E;
    ...
    invoke-direct {v1, v2, v3, v4}, LmN/f;-><init>(Ljava/io/File;J)V
    ...
    invoke-static {v2, v3, v4, v1}, LoN/b;->b(Ljava/lang/String;JLjava/util/concurrent/TimeUnit;)I

    move-result v3

    iput v3, v0, LmN/D;->w:I
    ...
    iput v5, v0, LmN/D;->x:I

    invoke-static {v2, v3, v4, v1}, LoN/b;->b(Ljava/lang/String;JLjava/util/concurrent/TimeUnit;)I

    move-result v1

    iput v1, v0, LmN/D;->y:I
...
# virtual methods
.method public final getRetrofit$core_5_2_1_release()LNN/W;
    .locals 1

    iget-object v0, p0, Lio/purchasely/network/AnalyticsService;->retrofit:LNN/W;
...
.method public final reset()V
    ...
    iput-object v0, p0, Lio/purchasely/network/AnalyticsService;->retrofit:LNN/W;

    return-void
.end method

.method public final setRetrofit$core_5_2_1_release(LNN/W;)V
    .locals 1
