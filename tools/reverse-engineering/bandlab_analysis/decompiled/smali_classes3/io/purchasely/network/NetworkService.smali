...
.method public constructor <init>(Lio/purchasely/network/NetworkInterceptor;Lio/purchasely/network/AnalyticsInterceptor;)V
    ...
    invoke-direct {p0}, Lio/purchasely/network/NetworkService;->buildRetrofit()LNN/W;

    move-result-object p1

    iput-object p1, p0, Lio/purchasely/network/NetworkService;->retrofit:LNN/W;
...
.method private final buildRetrofit()LNN/W;
    ...
    invoke-direct {p0}, Lio/purchasely/network/NetworkService;->provideOkHttpClient()LmN/E;
    ...
    invoke-virtual {v1}, Lio/purchasely/ext/PLYAPIEnvironment;->getApiUrl$core_5_2_1_release()Ljava/lang/String;
...
.method private final provideOkHttpClient()LmN/E;
    ...
    iput-object v0, p0, Lio/purchasely/network/NetworkService;->cache:LmN/f;

    new-instance v0, LmN/D;

    invoke-direct {v0}, LmN/D;-><init>()V

    iget-object v1, p0, Lio/purchasely/network/NetworkService;->cache:LmN/f;
    ...
    iput v5, v0, LmN/D;->y:I

    invoke-static {v2, v3, v4, v1}, LoN/b;->b(Ljava/lang/String;JLjava/util/concurrent/TimeUnit;)I

    move-result v1

    iput v1, v0, LmN/D;->w:I
...
.method public final getRetrofit()LNN/W;
    ...
    iget-object v0, p0, Lio/purchasely/network/NetworkService;->retrofit:LNN/W;
...
.method public final reset()V
    ...
    iput-object v0, p0, Lio/purchasely/network/NetworkService;->retrofit:LNN/W;
