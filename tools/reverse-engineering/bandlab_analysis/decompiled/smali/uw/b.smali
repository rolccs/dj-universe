...
.method static constructor <clinit>()V
    ...
    const-class v1, Luw/b;

    const-string v2, "param"

    const-string v3, "getParam$post_reactions_screen_debug()Lcom/bandlab/post/reactions/screen/PostReactionsParam;"
...
.method public constructor <init>()V
    ...
    sget-object v0, Luw/e;->Companion:Luw/d;

    invoke-virtual {v0}, Luw/d;->serializer()LaN/a;
    ...
    iput-object v0, p0, Luw/b;->s:Li/m;
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    iget-object p1, p0, Luw/b;->r:Luw/g;

    const/4 v0, 0x0

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Luw/g;->a()LRM/e1;

    move-result-object p1

    new-instance v1, Luw/a;

    invoke-direct {v1, p0, v0}, Luw/a;-><init>(Luw/b;LvM/d;)V
...
.method public final r(Landroidx/compose/runtime/k;I)V
    ...
    :cond_2
    :goto_1
    iget-object v0, p0, Luw/b;->r:Luw/g;

    if-eqz v0, :cond_4

    invoke-virtual {v0}, Luw/g;->b()LB0/j;

    move-result-object v0

    const/4 v1, 0x0

    invoke-static {v0, p1, v1}, Lcom/google/android/gms/internal/cast/f2;->o(LB0/j;Landroidx/compose/runtime/k;I)V
