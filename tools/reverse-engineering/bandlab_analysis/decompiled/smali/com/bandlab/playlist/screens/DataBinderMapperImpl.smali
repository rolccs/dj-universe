.class public Lcom/bandlab/playlist/screens/DataBinderMapperImpl;
.super LS2/e;
.source "SourceFile"
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/bandlab/playlist/screens/DataBinderMapperImpl;->a:Landroid/util/SparseIntArray;
...
.method public final b(Lgc/a;Landroid/view/View;I)LS2/u;
    ...
    sget-object v0, Lcom/bandlab/playlist/screens/DataBinderMapperImpl;->a:Landroid/util/SparseIntArray;
    ...
    :pswitch_0
    const-string p3, "layout/item_collection_small_0"
    ...
    new-instance p3, LVv/l;

    invoke-direct {p3, p1, p2}, LVv/l;-><init>(Lgc/a;Landroid/view/View;)V
    ...
    const-string p2, "The tag for item_collection_small is invalid. Received: "
    ...
    :pswitch_1
    const-string p3, "layout/item_collection_0"
    ...
    new-instance p3, LVv/h;

    invoke-direct {p3, p1, p2}, LVv/h;-><init>(Lgc/a;Landroid/view/View;)V
    ...
    const-string p2, "The tag for item_collection is invalid. Received: "
    ...
    :pswitch_2
    const-string p3, "layout/collection_loader_skeleton_0"
    ...
    new-instance p3, LVv/f;

    invoke-direct {p3, p1, p2}, LVv/f;-><init>(Lgc/a;Landroid/view/View;)V
    ...
    const-string p2, "The tag for collection_loader_skeleton is invalid. Received: "
    ...
    :pswitch_3
    const-string p3, "layout/collection_loader_screen_0"
    ...
    new-instance p3, LUm/c;

    const/4 v0, 0x1

    invoke-direct {p3, p1, p2, v0}, LUm/c;-><init>(Lgc/a;Landroid/view/View;I)V
    ...
    const-string p2, "The tag for collection_loader_screen is invalid. Received: "
    ...
    :pswitch_4
    const-string p3, "layout/collection_header_0"
    ...
    new-instance p3, LVv/e;

    invoke-direct {p3, p1, p2}, LVv/e;-><init>(Lgc/a;Landroid/view/View;)V
    ...
    const-string p2, "The tag for collection_header is invalid. Received: "
    ...
    :pswitch_5
    const-string p3, "layout/activity_collection_0"
    ...
    new-instance p3, LVv/c;

    invoke-direct {p3, p1, p2}, LVv/c;-><init>(Lgc/a;Landroid/view/View;)V
    ...
    const-string p2, "The tag for activity_collection is invalid. Received: "
...
.method public final c(Lgc/a;[Landroid/view/View;I)LS2/u;
    ...
    :cond_0
    sget-object p1, Lcom/bandlab/playlist/screens/DataBinderMapperImpl;->a:Landroid/util/SparseIntArray;
...
.method public final d(Ljava/lang/String;)I
    ...
    :cond_0
    sget-object v1, LUv/a;->a:Ljava/util/HashMap;
