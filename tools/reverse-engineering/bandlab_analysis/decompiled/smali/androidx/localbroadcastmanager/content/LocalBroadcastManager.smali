...
.field private final mActions:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "Landroidx/localbroadcastmanager/content/b;",
            ">;>;"
        }
    .end annotation
.end field
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    new-instance v0, Landroidx/localbroadcastmanager/content/a;

    invoke-virtual {p1}, Landroid/content/Context;->getMainLooper()Landroid/os/Looper;

    move-result-object p1

    invoke-direct {v0, p0, p1}, Landroidx/localbroadcastmanager/content/a;-><init>(Landroidx/localbroadcastmanager/content/LocalBroadcastManager;Landroid/os/Looper;)V
...
.method public executePendingBroadcasts()V
    ...
    iget-object v5, v4, LYI/p;->c:Ljava/lang/Object;
    ...
    iget-object v7, v4, LYI/p;->c:Ljava/lang/Object;
    ...
    check-cast v7, Landroidx/localbroadcastmanager/content/b;

    iget-boolean v8, v7, Landroidx/localbroadcastmanager/content/b;->d:Z

    if-nez v8, :cond_2

    iget-object v7, v7, Landroidx/localbroadcastmanager/content/b;->b:Landroid/content/BroadcastReceiver;

    iget-object v8, p0, Landroidx/localbroadcastmanager/content/LocalBroadcastManager;->mAppContext:Landroid/content/Context;

    iget-object v9, v4, LYI/p;->b:Ljava/lang/Object;
...
.method public registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)V
    ...
    invoke-direct {v1, p1, p2}, Landroidx/localbroadcastmanager/content/b;-><init>(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)V
...
.method public sendBroadcast(Landroid/content/Intent;)Z
    ...
    check-cast v8, Landroidx/localbroadcastmanager/content/b;
    ...
    iget-object v7, v8, Landroidx/localbroadcastmanager/content/b;->a:Landroid/content/IntentFilter;
    ...
    :cond_3
    iget-boolean v5, v8, Landroidx/localbroadcastmanager/content/b;->c:Z
    ...
    :cond_5
    iget-object v5, v8, Landroidx/localbroadcastmanager/content/b;->a:Landroid/content/IntentFilter;
    ...
    iput-boolean v12, v3, Landroidx/localbroadcastmanager/content/b;->c:Z
    ...
    check-cast v3, Landroidx/localbroadcastmanager/content/b;

    const/4 v5, 0x0

    iput-boolean v5, v3, Landroidx/localbroadcastmanager/content/b;->c:Z
    ...
    invoke-direct {v5, v6, v0, v2}, LYI/p;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public unregisterReceiver(Landroid/content/BroadcastReceiver;)V
    ...
    check-cast v4, Landroidx/localbroadcastmanager/content/b;

    iput-boolean v3, v4, Landroidx/localbroadcastmanager/content/b;->d:Z

    const/4 v5, 0x0

    :goto_1
    iget-object v6, v4, Landroidx/localbroadcastmanager/content/b;->a:Landroid/content/IntentFilter;
    ...
    check-cast v9, Landroidx/localbroadcastmanager/content/b;

    iget-object v10, v9, Landroidx/localbroadcastmanager/content/b;->b:Landroid/content/BroadcastReceiver;

    if-ne v10, p1, :cond_1

    iput-boolean v3, v9, Landroidx/localbroadcastmanager/content/b;->d:Z
