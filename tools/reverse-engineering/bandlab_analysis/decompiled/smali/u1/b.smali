...
.method public static final a(Lu1/c;Lu1/G;)V
    .locals 7

    iget-object v0, p1, Lu1/G;->j:Ljava/util/ArrayList;
    ...
    iget-object v2, p1, Lu1/G;->j:Ljava/util/ArrayList;
    ...
    iget-object v5, v2, Lu1/K;->b:Ljava/lang/Object;

    iput-object v5, v3, Lu1/h;->d:Ljava/lang/Object;

    iput-boolean v4, v3, Lu1/h;->n:Z

    invoke-virtual {v3}, Lu1/D;->c()V

    iget-object v5, v3, Lu1/h;->s:Lo1/h;

    iget v6, v2, Lu1/K;->c:I

    invoke-virtual {v5, v6}, Lo1/h;->h(I)V

    invoke-virtual {v3}, Lu1/D;->c()V

    invoke-virtual {v3}, Lu1/D;->c()V

    iget-object v5, v2, Lu1/K;->d:Lo1/p;

    iput-object v5, v3, Lu1/h;->b:Lo1/p;

    invoke-virtual {v3}, Lu1/D;->c()V

    iget v5, v2, Lu1/K;->e:F

    iput v5, v3, Lu1/h;->c:F

    invoke-virtual {v3}, Lu1/D;->c()V

    iget-object v5, v2, Lu1/K;->f:Lo1/p;

    iput-object v5, v3, Lu1/h;->g:Lo1/p;

    invoke-virtual {v3}, Lu1/D;->c()V

    iget v5, v2, Lu1/K;->g:F

    iput v5, v3, Lu1/h;->e:F

    invoke-virtual {v3}, Lu1/D;->c()V

    iget v5, v2, Lu1/K;->h:F

    iput v5, v3, Lu1/h;->f:F

    iput-boolean v4, v3, Lu1/h;->o:Z

    invoke-virtual {v3}, Lu1/D;->c()V

    iget v5, v2, Lu1/K;->i:I

    iput v5, v3, Lu1/h;->h:I

    iput-boolean v4, v3, Lu1/h;->o:Z

    invoke-virtual {v3}, Lu1/D;->c()V

    iget v5, v2, Lu1/K;->j:I

    iput v5, v3, Lu1/h;->i:I

    iput-boolean v4, v3, Lu1/h;->o:Z

    invoke-virtual {v3}, Lu1/D;->c()V

    iget v5, v2, Lu1/K;->k:F

    iput v5, v3, Lu1/h;->j:F

    iput-boolean v4, v3, Lu1/h;->o:Z

    invoke-virtual {v3}, Lu1/D;->c()V

    iget v5, v2, Lu1/K;->l:F

    iput v5, v3, Lu1/h;->k:F

    iput-boolean v4, v3, Lu1/h;->p:Z

    invoke-virtual {v3}, Lu1/D;->c()V

    iget v5, v2, Lu1/K;->m:F

    iput v5, v3, Lu1/h;->l:F

    iput-boolean v4, v3, Lu1/h;->p:Z

    invoke-virtual {v3}, Lu1/D;->c()V

    iget v2, v2, Lu1/K;->n:F

    iput v2, v3, Lu1/h;->m:F

    iput-boolean v4, v3, Lu1/h;->p:Z

    invoke-virtual {v3}, Lu1/D;->c()V

    invoke-virtual {p0, v1, v3}, Lu1/c;->e(ILu1/D;)V

    goto :goto_1

    :cond_0
    instance-of v3, v2, Lu1/G;
    ...
    iget-object v5, v2, Lu1/G;->a:Ljava/lang/String;

    iput-object v5, v3, Lu1/c;->k:Ljava/lang/String;

    invoke-virtual {v3}, Lu1/D;->c()V

    iget v5, v2, Lu1/G;->b:F

    iput v5, v3, Lu1/c;->l:F

    iput-boolean v4, v3, Lu1/c;->s:Z

    invoke-virtual {v3}, Lu1/D;->c()V

    iget v5, v2, Lu1/G;->e:F

    iput v5, v3, Lu1/c;->o:F

    iput-boolean v4, v3, Lu1/c;->s:Z

    invoke-virtual {v3}, Lu1/D;->c()V

    iget v5, v2, Lu1/G;->f:F

    iput v5, v3, Lu1/c;->p:F

    iput-boolean v4, v3, Lu1/c;->s:Z

    invoke-virtual {v3}, Lu1/D;->c()V

    iget v5, v2, Lu1/G;->g:F

    iput v5, v3, Lu1/c;->q:F

    iput-boolean v4, v3, Lu1/c;->s:Z

    invoke-virtual {v3}, Lu1/D;->c()V

    iget v5, v2, Lu1/G;->h:F

    iput v5, v3, Lu1/c;->r:F

    iput-boolean v4, v3, Lu1/c;->s:Z

    invoke-virtual {v3}, Lu1/D;->c()V

    iget v5, v2, Lu1/G;->c:F

    iput v5, v3, Lu1/c;->m:F

    iput-boolean v4, v3, Lu1/c;->s:Z

    invoke-virtual {v3}, Lu1/D;->c()V

    iget v5, v2, Lu1/G;->d:F

    iput v5, v3, Lu1/c;->n:F

    iput-boolean v4, v3, Lu1/c;->s:Z

    invoke-virtual {v3}, Lu1/D;->c()V

    iget-object v5, v2, Lu1/G;->i:Ljava/util/List;

    iput-object v5, v3, Lu1/c;->f:Ljava/util/List;

    iput-boolean v4, v3, Lu1/c;->g:Z

    invoke-virtual {v3}, Lu1/D;->c()V

    invoke-static {v3, v2}, Lu1/b;->a(Lu1/c;Lu1/G;)V
...
.method public static final b(Lo1/N;DDDDDDDZZ)V
    .locals 52
    ...
    invoke-static/range {v0 .. v16}, Lu1/b;->b(Lo1/N;DDDDDDDZZ)V
    ...
    check-cast v14, Lo1/h;

    iget-object v14, v14, Lo1/h;->a:Landroid/graphics/Path;
...
.method public static final c(Lu1/f;Landroidx/compose/runtime/k;)Lu1/J;
    .locals 12
    ...
    invoke-static {v1, v2}, Lu1/b;->a(Lu1/c;Lu1/G;)V
    ...
    invoke-direct {v0, v1}, Lu1/J;-><init>(Lu1/c;)V

    const-wide/16 v6, 0x10

    iget-wide v8, p0, Lu1/f;->g:J
    ...
    invoke-direct {v1, v8, v9, v6}, Lo1/m;-><init>(JI)V
    ...
    invoke-direct {v6, v2, v3}, Ln1/e;-><init>(J)V

    iget-object v2, v0, Lu1/J;->a:Landroidx/compose/runtime/h0;

    invoke-virtual {v2, v6}, Landroidx/compose/runtime/h0;->setValue(Ljava/lang/Object;)V

    iget-boolean v2, p0, Lu1/f;->i:Z

    invoke-static {v2}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v2

    iget-object v3, v0, Lu1/J;->b:Landroidx/compose/runtime/h0;

    invoke-virtual {v3, v2}, Landroidx/compose/runtime/h0;->setValue(Ljava/lang/Object;)V

    iget-object v2, v0, Lu1/J;->c:Lu1/F;

    iget-object v3, v2, Lu1/F;->g:Landroidx/compose/runtime/h0;

    invoke-virtual {v3, v1}, Landroidx/compose/runtime/h0;->setValue(Ljava/lang/Object;)V

    new-instance v1, Ln1/e;

    invoke-direct {v1, v4, v5}, Ln1/e;-><init>(J)V

    iget-object v3, v2, Lu1/F;->i:Landroidx/compose/runtime/h0;

    invoke-virtual {v3, v1}, Landroidx/compose/runtime/h0;->setValue(Ljava/lang/Object;)V

    iget-object p0, p0, Lu1/f;->a:Ljava/lang/String;

    iput-object p0, v2, Lu1/F;->c:Ljava/lang/String;
...
.method public static final d(Ljava/util/List;Lo1/N;)Lo1/h;
    .locals 31
    ...
    iget-object v1, v14, Lo1/h;->a:Landroid/graphics/Path;
    ...
    :goto_0
    iget-object v15, v14, Lo1/h;->a:Landroid/graphics/Path;

    invoke-virtual {v15}, Landroid/graphics/Path;->rewind()V

    invoke-virtual {v14, v1}, Lo1/h;->h(I)V
    ...
    iget v6, v1, Lu1/v;->c:F

    add-float/2addr v2, v6

    iget v1, v1, Lu1/v;->d:F
    ...
    iget v2, v1, Lu1/n;->c:F

    iget v1, v1, Lu1/n;->d:F

    invoke-virtual {v14, v2, v1}, Lo1/h;->e(FF)V
    ...
    iget v6, v1, Lu1/u;->c:F

    iget v7, v1, Lu1/u;->d:F

    invoke-virtual {v15, v6, v7}, Landroid/graphics/Path;->rLineTo(FF)V

    iget v1, v1, Lu1/u;->c:F
    ...
    iget v2, v1, Lu1/m;->c:F

    iget v3, v1, Lu1/m;->d:F

    invoke-virtual {v14, v2, v3}, Lo1/h;->d(FF)V

    iget v1, v1, Lu1/m;->c:F
    ...
    iget v2, v1, Lu1/l;->c:F

    invoke-virtual {v14, v2, v3}, Lo1/h;->d(FF)V

    iget v1, v1, Lu1/l;->c:F

    goto :goto_6

    :cond_8
    instance-of v6, v10, Lu1/z;
    ...
    iget v3, v1, Lu1/A;->c:F

    invoke-virtual {v14, v2, v3}, Lo1/h;->d(FF)V

    iget v1, v1, Lu1/A;->c:F
    ...
    iget v5, v1, Lu1/s;->c:F

    iget v6, v1, Lu1/s;->d:F

    iget v7, v1, Lu1/s;->e:F

    iget v8, v1, Lu1/s;->f:F

    iget v9, v1, Lu1/s;->g:F

    iget v4, v1, Lu1/s;->h:F
    ...
    iget v4, v1, Lu1/s;->e:F

    add-float/2addr v4, v2

    iget v5, v1, Lu1/s;->f:F

    add-float/2addr v5, v3

    iget v6, v1, Lu1/s;->g:F

    add-float/2addr v2, v6

    iget v1, v1, Lu1/s;->h:F
    ...
    iget v5, v1, Lu1/k;->c:F

    iget v6, v1, Lu1/k;->d:F

    iget v7, v1, Lu1/k;->e:F

    iget v8, v1, Lu1/k;->f:F

    iget v9, v1, Lu1/k;->g:F

    iget v10, v1, Lu1/k;->h:F

    move-object v4, v15

    invoke-virtual/range {v4 .. v10}, Landroid/graphics/Path;->cubicTo(FFFFFF)V

    iget v2, v1, Lu1/k;->e:F

    iget v3, v1, Lu1/k;->f:F

    iget v4, v1, Lu1/k;->g:F

    iget v1, v1, Lu1/k;->h:F
    ...
    :cond_c
    instance-of v6, v0, Lu1/x;

    if-eqz v6, :cond_e

    iget-boolean v1, v1, Lu1/B;->a:Z
    ...
    iget v7, v1, Lu1/x;->c:F

    iget v8, v1, Lu1/x;->d:F

    iget v9, v1, Lu1/x;->e:F

    iget v10, v1, Lu1/x;->f:F

    move-object v4, v15

    invoke-virtual/range {v4 .. v10}, Landroid/graphics/Path;->rCubicTo(FFFFFF)V

    iget v4, v1, Lu1/x;->c:F

    add-float/2addr v4, v2

    iget v5, v1, Lu1/x;->d:F

    add-float/2addr v5, v3

    iget v6, v1, Lu1/x;->e:F

    add-float/2addr v2, v6

    iget v1, v1, Lu1/x;->f:F

    goto :goto_7

    :cond_e
    instance-of v6, v0, Lu1/p;
    ...
    iget v7, v1, Lu1/p;->c:F

    iget v8, v1, Lu1/p;->d:F

    iget v9, v1, Lu1/p;->e:F

    iget v10, v1, Lu1/p;->f:F

    move-object v4, v15

    invoke-virtual/range {v4 .. v10}, Landroid/graphics/Path;->cubicTo(FFFFFF)V

    iget v2, v1, Lu1/p;->c:F

    iget v3, v1, Lu1/p;->d:F

    iget v4, v1, Lu1/p;->e:F

    iget v1, v1, Lu1/p;->f:F

    goto :goto_8

    :cond_10
    instance-of v6, v0, Lu1/w;

    if-eqz v6, :cond_11

    move-object v10, v0

    check-cast v10, Lu1/w;

    iget v1, v10, Lu1/w;->c:F

    iget v4, v10, Lu1/w;->d:F

    iget v5, v10, Lu1/w;->e:F

    iget v6, v10, Lu1/w;->f:F
    ...
    iget v1, v10, Lu1/o;->c:F

    iget v2, v10, Lu1/o;->d:F

    iget v3, v10, Lu1/o;->e:F

    iget v4, v10, Lu1/o;->f:F
    ...
    :cond_12
    instance-of v6, v0, Lu1/y;

    if-eqz v6, :cond_14

    iget-boolean v1, v1, Lu1/B;->b:Z
    ...
    iget v5, v10, Lu1/y;->c:F

    iget v6, v10, Lu1/y;->d:F
    ...
    check-cast v10, Lu1/q;

    iget v1, v10, Lu1/q;->c:F

    iget v4, v10, Lu1/q;->d:F
    ...
    check-cast v10, Lu1/r;

    iget v1, v10, Lu1/r;->h:F

    add-float v8, v1, v2

    iget v1, v10, Lu1/r;->i:F
    ...
    iget v1, v10, Lu1/r;->d:F

    move-wide/from16 v23, v11

    float-to-double v11, v1

    iget v1, v10, Lu1/r;->e:F

    move-wide/from16 v25, v11

    float-to-double v11, v1

    iget-boolean v1, v10, Lu1/r;->f:Z

    move/from16 v16, v1

    iget-boolean v1, v10, Lu1/r;->g:Z
    ...
    invoke-static/range {v1 .. v17}, Lu1/b;->b(Lo1/N;DDDDDDDZZ)V
    ...
    check-cast v14, Lu1/i;

    iget v1, v14, Lu1/i;->h:F

    float-to-double v8, v1

    iget v15, v14, Lu1/i;->i:F

    float-to-double v10, v15

    iget v1, v14, Lu1/i;->c:F

    float-to-double v12, v1

    iget v1, v14, Lu1/i;->d:F

    float-to-double v2, v1

    iget v1, v14, Lu1/i;->e:F

    move-wide/from16 v25, v12

    float-to-double v12, v1

    iget-boolean v1, v14, Lu1/i;->f:Z

    move/from16 v16, v1

    iget-boolean v1, v14, Lu1/i;->g:Z
