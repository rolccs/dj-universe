...
.field public final synthetic o:LO8/k;
...
# direct methods
.method public constructor <init>(LP9/j;Ljava/io/File;LO8/k;Ljava/io/File;LvM/d;LP9/j;LQM/A;)V
    .locals 0

    iput-object p1, p0, LP9/h;->m:LP9/j;

    iput-object p2, p0, LP9/h;->n:Ljava/io/File;

    iput-object p3, p0, LP9/h;->o:LO8/k;

    iput-object p4, p0, LP9/h;->p:Ljava/io/File;

    iput-object p6, p0, LP9/h;->q:LP9/j;

    iput-object p7, p0, LP9/h;->r:LQM/A;
...
.method public final create(Ljava/lang/Object;LvM/d;)LvM/d;
    ...
    new-instance v8, LP9/h;

    iget-object v6, p0, LP9/h;->q:LP9/j;

    iget-object v7, p0, LP9/h;->r:LQM/A;

    iget-object v1, p0, LP9/h;->m:LP9/j;

    iget-object v2, p0, LP9/h;->n:Ljava/io/File;

    iget-object v3, p0, LP9/h;->o:LO8/k;

    iget-object v4, p0, LP9/h;->p:Ljava/io/File;

    move-object v0, v8

    move-object v5, p2

    invoke-direct/range {v0 .. v7}, LP9/h;-><init>(LP9/j;Ljava/io/File;LO8/k;Ljava/io/File;LvM/d;LP9/j;LQM/A;)V

    iput-object p1, v8, LP9/h;->l:Ljava/lang/Object;
...
.method public final invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, LP9/h;->create(Ljava/lang/Object;LvM/d;)LvM/d;
    ...
    invoke-virtual {p1, p2}, LP9/h;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget v3, v1, LP9/h;->k:I

    iget-object v4, v1, LP9/h;->o:LO8/k;

    iget-object v5, v1, LP9/h;->p:Ljava/io/File;

    const-string v7, "getMsg(...)"

    const/4 v8, 0x1

    iget-object v9, v1, LP9/h;->m:LP9/j;

    if-eqz v3, :cond_1

    if-ne v3, v8, :cond_0

    iget-object v2, v1, LP9/h;->j:Lcom/bandlab/audiocore/generated/Result;

    iget-object v3, v1, LP9/h;->l:Ljava/lang/Object;
    ...
    iget-object v10, v1, LP9/h;->n:Ljava/io/File;
    ...
    invoke-static {v9, v15, v4}, LP9/j;->c(LP9/j;Lcom/bandlab/audiocore/generated/AudioFileInfo;LO8/k;)V

    invoke-static {v3}, LOM/D;->u(LOM/B;)V

    new-instance v14, LP9/e;

    iget-object v12, v1, LP9/h;->q:LP9/j;

    iget-object v13, v1, LP9/h;->r:LQM/A;

    const/4 v6, 0x1

    invoke-direct {v14, v3, v12, v13, v6}, LP9/e;-><init>(LOM/B;LP9/j;LQM/A;I)V
    ...
    invoke-virtual {v6}, Lcom/bandlab/audiocore/generated/Result;->getOk()Z
    ...
    iput-object v10, v1, LP9/h;->l:Ljava/lang/Object;

    iput-object v6, v1, LP9/h;->j:Lcom/bandlab/audiocore/generated/Result;

    iput v8, v1, LP9/h;->k:I

    iget v11, v9, LP9/j;->e:I

    invoke-virtual {v3, v5, v11, v1}, LZ9/h;->b(Ljava/io/File;ILxM/c;)Ljava/lang/Object;
    ...
    invoke-direct {v0, v7, v8}, LxD/p;-><init>(D)V

    invoke-static {v4, v0}, LP9/j;->d(LO8/k;LxD/p;)V
    ...
    const-string v5, "getProjectSettingsForAudioTrackImport(...)"
    ...
    iget-object v0, v1, LP9/h;->m:LP9/j;
    ...
    :cond_7
    new-instance v4, Lcom/bandlab/audio/controller/api/ImportException$OpenResultWavFail;
    ...
    invoke-direct {v4, v0}, Lcom/bandlab/audio/controller/api/ImportException$OpenResultWavFail;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v6}, Lcom/bandlab/audiocore/generated/Result;->getMsg()Ljava/lang/String;
